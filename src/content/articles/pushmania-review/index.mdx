---
title: "Pushmania explores videogame history through block pushing puzzles"
...
review:
  ...
  plusses:
    ...
    - "Some truly novel block-pushing mechanics in later levels"
  minuses:
...
The puzzles themselves start as straightforward block pushing: you need to get a golden cube to its target by scooting obstacles out of the way. Before long though, _Pushmania_ adds new gameplay elements like blocks that can be pulled, destroyed, or sent (with cargo!) over long distances. There are sometimes even usable items, something I don't recall from any similar games.

As you progress through the game, you'll find a few worlds with truly novel mechanics. I don't want to spoil anything, but each of these worlds pushes the boundaries of the "block pushing" genre itself, which was awesome. Those level were a pleasant surprise that helped soften the fact that you spend a _lot_ of time pushing blocks around.
