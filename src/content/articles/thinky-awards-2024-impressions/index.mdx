---
title: "Thinky Awards 2024 Nominee Impressions"
...
{/* I'm not sure there'll be a 2024-specific link, so I'll point to an archive if I need to. */}
{/* https://web.archive.org/web/20250130043921/https://thinkygames.com/awards/ */}

![](./thinky_og.png)

It was my great honor to be a juror for the [2024 Thinky Awards](https://thinkygames.com/events/awards/2024/). They showcase the year’s best puzzle games across a variety of categories, such as "Most Innovative", "Most Accessible", and of course, "Game of the Year".
...
That's it! A big thanks to [Joseph](https://josephmansfield.uk/) from [Thinky Games](https://thinkygames.com/) for reaching out and to all the nominees for releasing such compelling games.
