...
// annoying to duplicate these, but I can't render Astro components from React and its SVG parsing brings in Astro
...
export const BookIcon = (): JSX.Element => (
  <svg
    ...
    viewBox="0 0 448 512"
    className={`${sharedTWClasses} fill-emerald-600`}
  >
...
export const MovieIcon = (): JSX.Element => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    viewBox="0 0 512 512"
    className={`${sharedTWClasses} fill-red-600`}
  >
    {/* Font Awesome Pro 6.4.2 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2023 Fonticons, Inc. */}
...
export const GameIcon = (): JSX.Element => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    viewBox="0 0 640 512"
    className={`${sharedTWClasses} fill-blue-600`}
  >
    {/* Font Awesome Pro 6.4.2 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2023 Fonticons, Inc. */}
...
export const StarIcon = (): JSX.Element => (
  <div className={sharedTWClasses}>⭐</div>
);

export const ArticleIcon = (): JSX.Element => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    viewBox="0 0 512 512"
    className={`${sharedTWClasses} fill-purple-600`}
  >
