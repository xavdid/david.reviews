...
const sharedTWClasses = "inline h-6";
const defaultPadding = "px-1";
...
export const BookIcon = ({
  ...
  <svg
    ...
    viewBox="0 0 448 512"
    className={`${sharedTWClasses} ${padding} fill-emerald-600`}
  >
...
export const MovieIcon = ({
  ...
  <svg
    xmlns="http://www.w3.org/2000/svg"
    viewBox="0 0 512 512"
    className={`${sharedTWClasses} ${padding} fill-red-600`}
  >
    {/* Font Awesome Pro 6.4.2 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2023 Fonticons, Inc. */}
...
export const GameIcon = ({
  ...
  <svg
    xmlns="http://www.w3.org/2000/svg"
    viewBox="0 0 640 512"
    className={`${sharedTWClasses} ${padding} fill-blue-600`}
  >
    {/* Font Awesome Pro 6.4.2 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2023 Fonticons, Inc. */}
...
export const StarIcon = (): JSX.Element => (
  <div className={`${sharedTWClasses} ${defaultPadding}`}>⭐</div>
);
...
export const ArticleIcon = (): JSX.Element => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    viewBox="0 0 512 512"
    className={`${sharedTWClasses} ${defaultPadding} fill-purple-600`}
  >
