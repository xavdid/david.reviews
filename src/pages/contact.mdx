...
In exchange for being provided a review key, I'm happy to publish an honest, long-form review of your game (like the one I <SubtleLink href="/articles/beast-breaker-review/">wrote for Beast Breaker</SubtleLink>). I'm able to review on any of the following platforms (listed in rough order of preference):
...
Writing takes time and I've got a day job, but I do my best to accomodate the requests I get. If you need the review published by a certain date, please include that (and any embargo information) in your inquiry.
