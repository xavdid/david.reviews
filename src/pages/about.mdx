...
Throughout 2024, I grew increasingly frustrated with the state of the web. Everything online is designed for SEO (and now, AI), not humans.

I got curious what a review site would look like if it wasn't profit motivated. If a website wasn't optimized for engagement and revenue, then it wouldn't need auto-playing video following you as you scrolled. You could also skip the exaggerated SEO headlines and ads plastered over everything. Gone also are sponsored posts or "recommendation" posts that are just lists of Amazon referrals.
...
But that's also why it feels like it's the _most important_ time to launch this project. In a world that's losing some of its humanity, we need small, independent reviewers: real people who write because they love the subject matter, not to get eyeballs on the site.
...
In order to prove I'm an outlet worth sending review copies to, I typically have to demonstrate some level of readership and audience. A Steam curator page is a great way to do this, since it shows my follower count and some basic analytics about people buying games from my curator page.
...
If that sounds great, please give me a follow: <SubtleLink href="https://store.steampowered.com/curator/45203122/">steampowered.com/curator/45203122</SubtleLink>
