...
Since 2016, I've used <ExternalLink href="https://airtable.com/">Airtable</ExternalLink> to track everything I play, watch, and read. Then, each January, I'd write a <ExternalLink href="https://xavd.id/blog/tags/yearly-review">yearly review</ExternalLink> of my favorite things from the previous year.
...
Throughout 2024, I grew increasingly frustrated with the state of the web. Everything is designed for SEO (and now, AI), not humans.

I became curious what a review site would look like if it wasn't profit motivated. If a website wasn't optimized for engagement and revenue, then it wouldn't need auto-playing video following you as you scrolled. You could also skip the exaggerated SEO headlines and ads plastered over everything. Gone also are sponsored posts or "recommendation" posts that are just lists of Amazon referrals.

So, that's my goal with _david.reviews_: **a media review site you actually enjoy reading**. It's wicked fast, information dense, and respects you as a reader. There are no modals, no sponsored content, no fluff. 100% written by me, a real person who really likes games and movies and books.

### Why Now?

It might seem silly to launch a review site in 2024. It's an extremely crowded field and AI-generated content is everywhere at this point.

But that's also why it feels like it's the _most important_ time to launch this project. In a world that feels like it's losing some of its humanity, we need small, independent reviewers more than ever. People who review for their love of the genre, not what will get the most eyeballs on the site.
...
- Follow me on Steam: <ExternalLink href="https://store.steampowered.com/curator/45203122/">store.steampowered.com/curator/45203122</ExternalLink>
...
In order to prove I'm an outlet worth sending review copies to, I typically have to demonstrate some level of readership and audience. A Steam curator page is a great way to do this, since it shows follower count and some basic analytics about people buying games from my curator page.

So, kindly hit that big "Follow" button: <ExternalLink href="https://store.steampowered.com/curator/45203122/">store.steampowered.com/curator/45203122</ExternalLink>
...
If that sounds great, please give me a follow: <SubtleLink href="https://store.steampowered.com/curator/45203122/">store.steampowered.com/curator/45203122</SubtleLink>

### Send Me Your Game

I play a lot of indie games, which typically cost money. If you're a a developer (or publisher) who wants to see your game reviewed here, please <SubtleLink href="/contact">get in touch</SubtleLink>!
